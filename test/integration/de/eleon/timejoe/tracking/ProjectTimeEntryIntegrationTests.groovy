...
class ProjectTimeEntryIntegrationTests extends GroovyTestCase {
	...
	void testDuplicateAutoCompleteCreation() {
		...
		assertTrue "AutoCompleteElem sollte jetzt zwei Eintr�ge enthalten.", AutoCompleteElem.list().size() == 2
		...
		assertTrue "AutoCompleteElem sollte jetzt drei Eintr�ge enthalten.", AutoCompleteElem.list().size() == 3
	}
}
